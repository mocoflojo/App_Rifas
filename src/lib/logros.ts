 ...
 *  cierre_sorteo (migración 0015).
 *
 *  Los identificadores siguen diciendo "top_mes" por compatibilidad con las
 *  filas ya guardadas en `logros`: renombrarlos obligaría a migrar el
 *  histórico de los vendedores a cambio de nada.
 *
...
type DefinicionLogro = {
  ...
  color: string;
  /** Solo se resuelve al cerrar el sorteo: no hay forma de "ir progresando". */
...
export const CATALOGO_LOGROS: Record<LogroId, DefinicionLogro> = {
  vendedor_rapido: {
    ...
    descripcion: (_cupo, dias) =>
      `30 tickets activos en los primeros ${dias} días del sorteo.`,
  ...
  sesenta: {
    ...
    descripcion: (cupo) => `Alcanzaste tus ${cupo} tickets activos del sorteo.`,
  ...
  racha_3: {
    emoji: "🔥",
    nombre: "En racha",
    descripcion: (cupo) => `Cupo completo (${cupo}/${cupo}) tres sorteos seguidos.`,
  ...
  top_mes_1: {
    ...
    descripcion: () => "El que más tickets activos tuvo al cerrar el sorteo.",
    color: "bg-estado-apartado-bg",
    soloAlCierre: true,
  },
  top_mes_2: {
    ...
    descripcion: () => "Segundo lugar en tickets activos al cerrar el sorteo.",
  ...
  top_mes_3: {
    ...
    descripcion: () => "Tercer lugar en tickets activos al cerrar el sorteo.",
